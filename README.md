...
Debox is available for Scala 2.11, 2.12, 2.13, Scala 3, and Scala.js 1.x. (Latest supported versions
...
libraryDependencies += "org.scorexfoundation" %% "debox" % "0.11.0"
```
